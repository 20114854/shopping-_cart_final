...
<form action="includes/login_inc.php" class="form-signin" method="post">
  ...
  <input type="text"  id="inputStudName" name="StudName" class="form-control mb-2" placeholder="Username" >
  <label for="inputSPassword" class="sr-only">Password</label>
  <input type="password" name="SPassword" id="inputSPassword" class="form-control" placeholder="Password" required>
